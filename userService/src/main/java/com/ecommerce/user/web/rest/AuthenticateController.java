...
import com.ecommerce.user.repository.AuthorityRepository;
import com.ecommerce.user.web.rest.vm.LoginVM;
...
public class AuthenticateController {
    ...
    public AuthenticateController(JwtEncoder jwtEncoder, AuthenticationManagerBuilder authenticationManagerBuilder, AuthorityRepository authorityRepository) {
