...
import { Checkbox, Button, IconButton, TextInput, Card } from 'react-native-paper';
  ...
  const renderItem = ({ item }) => (
    <Card style={styles.card}>
      <View style={styles.itemRow}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ProductDetail', { productId: item.productId })} style={styles.itemInfo}>
        ...
        <View style={styles.actions}>
          ...
          />
          <IconButton icon="delete" iconColor="red" onPress={() => removeFromCart(item.productId)} />
        </View>
      </View>
    </Card>
  );
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.footerRight}>
          ...
          <Button
            ...
            buttonColor="#007AFF" textColor="white"
          >
            Check Out
          </Button>
        </View>
