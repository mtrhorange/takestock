...
export const OrderItem = () => {
  ...
  const orderItemList = useAppSelector(state => state.gateway.orderItem.entities);
  const loading = useAppSelector(state => state.gateway.orderItem.loading);
  const totalItems = useAppSelector(state => state.gateway.orderItem.totalItems);
      ...
      <h2 id="order-item-heading" data-cy="OrderItemHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.orderItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.orderItem.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="gatewayApp.orderItem.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
