...
export const Product = () => {
  ...
  const totalItems = useAppSelector(state => state.gateway.product.totalItems);
      ...
      <h2 id="product-heading" data-cy="ProductHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.product.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.product.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="gatewayApp.product.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                ...
                <th className="hand" onClick={sort('tags')}>
                  <Translate contentKey="gatewayApp.product.tags">Tags</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('tags')} />
                </th>
                <th />
              </tr>
            </thead>
