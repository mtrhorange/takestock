...
import { deleteEntity, getEntity } from './user-activity.reducer';
...
export const UserActivityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.userActivity.delete.question">
        <Translate contentKey="gatewayApp.userActivity.delete.question" interpolate={{ id: userActivityEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-userActivity" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
