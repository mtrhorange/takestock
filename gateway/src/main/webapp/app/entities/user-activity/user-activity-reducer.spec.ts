...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERACTIVITY actions', async () => {
      const arg = { id: 26983 };
    ...
    it('dispatches UPDATE_USERACTIVITY actions', async () => {
      const arg = { id: 26983 };
    ...
    it('dispatches PARTIAL_UPDATE_USERACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERACTIVITY actions', async () => {
      const arg = 42666;
