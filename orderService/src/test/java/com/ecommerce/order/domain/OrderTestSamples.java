...
public class OrderTestSamples {
    ...
    public static Order getOrderSample1() {
        return new Order().id(1L).userId(1L).orderStatus("orderStatus1").paymentStatus("paymentStatus1");
    }

    public static Order getOrderSample2() {
        return new Order().id(2L).userId(2L).orderStatus("orderStatus2").paymentStatus("paymentStatus2");
    }
