...
public class PaymentTestSamples {
    ...
    public static Payment getPaymentSample1() {
        return new Payment().id(1L).paymentMethod("paymentMethod1").transactionId("transactionId1").paymentStatus("paymentStatus1");
    }

    public static Payment getPaymentSample2() {
        return new Payment().id(2L).paymentMethod("paymentMethod2").transactionId("transactionId2").paymentStatus("paymentStatus2");
    }
