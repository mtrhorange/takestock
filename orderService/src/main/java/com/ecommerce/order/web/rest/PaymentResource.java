...
/**
* REST controller for managing {@link com.ecommerce.order.domain.Payment}.
*/
@RestController
...
public class PaymentResource {
   ...
   private static final String ENTITY_NAME = "orderServicePayment";
   ...
   public ResponseEntity<PaymentDTO> getPayment(@PathVariable("id") Long id) {
       ...
       return ResponseEntity.ok(paymentDTO.orElseThrow());
